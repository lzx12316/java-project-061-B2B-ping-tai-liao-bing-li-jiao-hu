...
本项目是 **基于B2B平台的医疗病历交互系统**，采用主流 Java Web 技术栈开发，功能完整、结构清晰，非常适合作为毕业设计或课程设计的参考源码。

**仓库名**：`java-project-061-B2B-ping-tai-liao-bing-li-jiao-hu`

**原始压缩包名**：`springboot061基于B2B平台的医疗病历交互系统`
